...
<!-- Main Panel -->
    <div class="col-md-10 bg-success "style="display:none;height: 100vh;">
      <div class="card mt-3">
        <div class="card-body ">
          <h5 class="card-title text-center pb-3"> Detail Data Pasien</h5>
            <div class="container">
              <form method="POST" action="proses.php">
                ...
                <div class="form-group">
                  ...
                  <select name="jamin" class="form-control" id="penjamin" name="penjamin" disabled>
                ...
                <div class="form-group">
                  ...
                  <input value="<?php echo $nama ?>" name="nama" type="text" class="form-control" id="nama" placeholder="Masukkan nama pasien" name="nama" readonly>
                </div>
                <div class="form-group">
                  <label for="tanggal_lahir">Tanggal Lahir:</label>
                  <input value="<?php echo $tanggal_lahir ?>" name="tl" type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" readonly>
                </div>
                <div class="form-group">
              ...
              <?php
                  ...
                  ?>
                      ...
                      <a href="pasien.php" class="btn btn-danger px-4 mt-3"> <i class="fa fa-reply"></i> Kembali</a>
                  <?php
                  } 
                ?>
            </div>
