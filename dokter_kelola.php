...
<?php
  ...
  $alamat='';
  $lama_bekerja='';
  if(isset($_GET['ubah_dokter'])){
    $no_urut=$_GET['ubah_dokter'];
    
    $query="SELECT * FROM dokter WHERE no_urut='$no_urut';";
  ...
  <div class="container-fluid mt-0">
    <div class="row">
      ...
      <div class="col-md-10 bg-success "style="display:none;height: 100vh;">
        <div class="card mt-3">
          <div class="card-body ">
            <h5 class="card-title text-center pb-3"> Input Data Dokter</h5>
            <div class="container">
                      <form method="POST" action="dokter_proses.php">
                        <input type="hidden" value="<?php echo"$no_urut"?> " name="no_id">
                        <div class="form-group">
                          <label for="no_rekam_medis">Id Dokter:</label>
                          <input name="id_dokter" type="text" class="form-control" id="id_dokter" placeholder="Masukkan id dokter"  value="<?php echo"$id_dokter"  ?>">
                        </div>
                        
                        <div class="form-group">
                          <label  for="nama">Nama:</label>
                          <input value="<?php echo"$nama"?>" name="nama" type="text" class="form-control" id="nama" placeholder="Masukkan nama dokter" name="nama">
                        </div>
                        <div class="form-group">
                          <label for="tanggal_lahir">Tanggal Lahir:</label>
                          <input value="<?php echo"$tanggal_lahir"?>"name="tanggal_lahir" type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir">
                        </div>
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input value="<?php echo"$alamat"?>"name="alamat"type="text" class="form-control" id="alamat" placeholder="Masukkan alamat dokter" name="alamat">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="dpjp">Lama Bekerja:</label>
                          <input value="<?php echo"$lama_bekerja"?>"name="lama_bekerja" type="date" class="form-control" id="lama_bekerja" placeholder="Masukkan lama bekerja" name="lama_bekerja">
                        </div>
                        <div class="">
                        <?php
if(isset($_GET['ubah_dokter'])){
?>
    <button type="submit" name="aksi" value="edit_dokter" class="btn btn-primary px-4 mt-3"> 
        <i class="fa fa-floppy-disk"></i> Simpan Perubahan
    </button>
    <a href="dokter.php" class="btn btn-danger px-4 mt-3"> <i class="fa fa-reply"></i> Batal</a>
<?php
} else{
?>
    <button type="submit" name="aksi" value="add_dokter" class="btn btn-primary px-4 mt-3"> 
